...
function MyCarousel() {
    return (
      <div>
        ...
        <Carousel interval={null}>
            <Carousel.Item>
              <div className="container-fluid ">
                <div className="row py-3 comment_div">
        ...
        <div className="row text-center pink-color"><p><strong>Read more reivews on: </strong></p></div>

        <div className="row text-center pink-color pb-3 px-0">
          <div className="col">
